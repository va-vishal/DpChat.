    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        switch (title) {
            ...
            case "views":
                ...
                break;
            default:
                Toast.makeText(FollowersActivity.this, "Invalid title", Toast.LENGTH_SHORT).show();
                break;
        }
    }
    ...
    private void getFollowers() {
        ...
        reference.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onCancelled(DatabaseError databaseError) {
                Toast.makeText(FollowersActivity.this, databaseError.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
    }
